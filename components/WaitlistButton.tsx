...
export default function WaitlistButton({
  ...
  const triggerClass =
    variant === "nav"
      ...
      : "inline-block rounded-md border border-line bg-canvas px-6 py-3 text-[13px] font-semibold text-ink transition-transform duration-300 ease-out hover:scale-[1.04]";
  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-[420px] rounded-lg bg-canvas p-8 shadow-xl"
          ...
          >
            {status === "sent" ? (
              <>
                ...
                <button
                  onClick={() => setOpen(false)}
                  className="mt-6 rounded-md bg-primary px-4 py-2 text-[13px] font-semibold text-ink"
                >
                  Close
                </button>
              </>
              ...
              <>
                <p className="text-[16px] font-bold">Join the waitlist</p>
                <p className="mt-2 text-[13px] leading-relaxed text-mute">
                ...
                <form onSubmit={handleSubmit} className="mt-5 space-y-3">
                  <input
                    ...
                    className="w-full rounded-md border border-line px-3 py-2 text-[13px] outline-none focus:border-primary"
                  />
                  <input
                    required
                    type="email"
                  ...
                  <div className="flex gap-2 pt-1">
                    <button
                      ...
                      className="flex-1 rounded-md bg-primary px-4 py-2 text-[13px] font-semibold text-ink disabled:opacity-60"
                    >
